...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        if (workoutRepo.count() == 0) {
            Workout workout1 = new Workout("workout1", "Full Body Strength", List.of(
            ...
            Workout workout2 = new Workout("workout2", "Upper Body Hypertrophy", List.of(
            ...
            Workout workout3 = new Workout("workout3", "Lower Body Endurance", List.of(
